          ...
          .row.justify-content-center.align-items-center
            .col-lg-7
              ul.lista-ul--color.p-4.bg-t1-3
                ...
                li.d-flex
                  i.bg-icon-ul
                  p.mb-0.ms-2 Son clasificados como activos no corrientes o de largo plazo.
                li.d-flex
                  i.bg-icon-ul
      ...
      .row.justify-content-around.align-items-center
        ...
        .col
          .row.justify-content-between.align-items-center
            ...
            .col-sm-auto
              a.boton.color-acento-botones(href="downloads/anexos/Anexo_2_Norma_NIC_40.pdf" target="_blank")
                span.text-black Descargar
                i.fas.fa-file-download.text-black
</template>
<script>
